    ...
    public class UsersRepository
    {
        ...
        */
        ...
        public async Task<User> GetUserAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            var user = await _usersCollection.Find(Builders<User>.Filter.Eq(x => x.Email, email)).FirstOrDefaultAsync(cancellationToken);
            return user;
        }
            ...
            try
            {
                ...
                */
                ...
                updateResult = await _usersCollection.UpdateOneAsync(
                    ...
                    Builders<User>.Update.Set(x => x.Preferences, user.Preferences),
        ...
        //    try
        //    {
        //        var updateResponse = await _usersCollection.UpdateOneAsync(
        ...
        //        return updateResponse.MatchedCount == 0
        //           ? new UserResponse(false, "No user found with that email")
        //           : new UserResponse(true, updateResponse.IsAcknowledged.ToString());
        //    }
        //    catch (Exception e)
        //    {
        //        return new UserResponse(false, e.Message);
